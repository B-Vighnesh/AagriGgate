...
SELECT 'PIB Agriculture', 'pib.gov.in', 'https://www.pib.gov.in/rssfeed.aspx?mincode=2', 'SUBSIDY,LAW', 'RSS', NULL, 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'Kisan Rath', 'kisanrath.in', 'https://www.kisanrath.in/feed', 'MARKET,SUBSIDY', 'RSS', NULL, 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'GNews: kisan subsidy', 'gnews.io', 'https://gnews.io/api/v4/search', 'SUBSIDY,LOAN', 'GNEWS_KEYWORD', 'kisan subsidy', 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'GNews: mandi price', 'gnews.io', 'https://gnews.io/api/v4/search', 'MARKET', 'GNEWS_KEYWORD', 'mandi price', 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'GNews: agriculture law', 'gnews.io', 'https://gnews.io/api/v4/search', 'LAW', 'GNEWS_KEYWORD', 'agriculture law', 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'GNews: crop weather', 'gnews.io', 'https://gnews.io/api/v4/search', 'WEATHER', 'GNEWS_KEYWORD', 'crop weather', 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'GNews: farm loan', 'gnews.io', 'https://gnews.io/api/v4/search', 'LOAN', 'GNEWS_KEYWORD', 'farm loan', 1, NOW(), NOW()
...
INSERT INTO trusted_source (name, domain, source_url, category_scope, source_type, fetch_keyword, is_active, created_at, updated_at)
SELECT 'GNews: agri scheme', 'gnews.io', 'https://gnews.io/api/v4/search', 'SUBSIDY', 'GNEWS_KEYWORD', 'agri scheme', 1, NOW(), NOW()
